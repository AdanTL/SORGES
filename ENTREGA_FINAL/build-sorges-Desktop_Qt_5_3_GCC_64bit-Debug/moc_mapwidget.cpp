...
#include "../SORGES-sourcecode-20150126/widgets/mapwidget.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_MapWidget_t, stringdata) + ofs \
...
QT_MOC_LITERAL(8, 82, 20),
QT_MOC_LITERAL(9, 103, 15),
QT_MOC_LITERAL(10, 119, 12),
QT_MOC_LITERAL(11, 132, 15),
QT_MOC_LITERAL(12, 148, 18)
    },
    "MapWidget\0paintOrigin\0\0Origin\0origin\0"
    "paintStations\0std::set<Station>\0"
    "stationsList\0changeStationsColors\0"
    "changedStations\0paintCircles\0"
    "showInformation\0clearScreenTimeout"
};
...
void MapWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->paintOrigin((*reinterpret_cast< const Origin(*)>(_a[1]))); break;
        case 1: _t->paintStations((*reinterpret_cast< const std::set<Station>(*)>(_a[1]))); break;
        case 2: _t->changeStationsColors((*reinterpret_cast< const std::set<Station>(*)>(_a[1]))); break;
        case 3: _t->paintCircles(); break;
        case 4: _t->showInformation(); break;
        case 5: _t->clearScreenTimeout(); break;
        default: ;
        }
    }
}
